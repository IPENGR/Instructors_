...
console.log(intersection([], [3, 4, 5, 6])); // output - []
console.log(intersection([1, 2, 3, 4], [3, 4, 5, 6])); // output - [3,4]
console.log(intersection([1, 2, 3, 4], "3, 4")); // output - Error("Invalid inputs. Please provide valid arrays.");
console.log(intersection(4, [3, 4, 5, 6])); // output - Error("Invalid inputs. Please provide valid arrays.");
